...
from Scouting2013.model.reusable_models import Team, Match, OfficialMatch, \
...
class AddTeamCommentsView(View):
    ...
    def post(self, request, team_number):
        ...
        return HttpResponseRedirect(reverse('Scouting2013:view_team', args=(team_number,)))
...
class AddTeamPictureView(View):
    ...
    def post(self, request):
        ...
        return HttpResponseRedirect(reverse('Scouting2013:view_team', args=(team_numer,)))
...
class AllTeamsViews(TemplateView):
    ...
    template_name = 'Scouting2013/all_teams.html'
...
class SingleTeamView(TemplateView):
    ...
    template_name = 'Scouting2013/view_team.html'
...
class AllMatchesView(TemplateView):
    ...
    template_name = 'Scouting2013/all_matches.html'
...
class SingleMatchView(TemplateView):
    ...
    template_name = 'Scouting2013/view_match.html'
...
class OfficialMatchView(TemplateView):
    ...
    template_name = 'Scouting2013/view_official_match.html'
