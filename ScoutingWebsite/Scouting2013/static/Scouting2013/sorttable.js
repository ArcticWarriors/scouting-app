    ...
    for (var i=0; i<headrow.length; i++) {
      ...
      if (!headrow[i].className.match(/\bsorttable_nosort\b/)) { // skip this col
        ...
        if (mtch) { override = mtch[1]; }
	      ...
	      dean_addEvent(headrow[i],"click", sorttable.innerSortFunction = function(e, manualSortReverse) {
					if (this.parentNode.parentNode.parentNode.className.search("no-manual-sort") == -1 || manualSortReverse !== undefined) {
						if (manualSortReverse === undefined) {
