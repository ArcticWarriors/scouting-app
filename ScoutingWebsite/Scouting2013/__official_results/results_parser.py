...
from Scouting2013.model.reusable_models import OfficialMatch, Competition, Team, \
    Match
from Scouting2013.model.models2011 import OfficialMatchScoreResult

competition = Competition.objects.get(id=1)

with open(r'C:\Users\PJ\GitHub\SnobotScouting\scouting-app\ScoutingWebsite\Scouting2013\__official_results\spbli_results.txt') as f:
